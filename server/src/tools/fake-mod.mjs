...
const script = [
	...
	{ cmd: 'roundstart' },
	{ cmd: 'kill', args: [ a, c ], weapon: 'ak47' },
	{ cmd: 'headshot', args: [ d, b ], weapon: 'deagle', headshot: true },
	{ cmd: 'knife', args: [ a, d ], weapon: 'knife', sound: 'jeppeknife' },
	{ cmd: 'alone' },
	{ cmd: 'round' },
	{ cmd: 'roundstart' },
	{ cmd: 'tk', args: [ c, d ], weapon: 'm4a1' },
	{ cmd: 'paused' },
	{ cmd: 'resumed' },
	{ cmd: 'unpause' },
	{ cmd: 'suicide', args: [ b ], weapon: 'grenade' },
	{ cmd: 'grenade', args: [ c, a ], weapon: 'grenade' },
	{ cmd: 'mapend' },
]
