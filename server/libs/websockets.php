...
abstract class WebSocketServer {
  ...
  function __construct($addr, $port, $bufferLength = 2048) {
    ...
    socket_set_option($this->master, SOL_SOCKET, SO_LINGER, array ('l_linger' => 0, 'l_onoff' => 0)) or die("socket_set_option() failed: reason: ". socket_strerror(socket_last_error()) ."\n");
